<?php	
	$posting_laris="<div class=\"judul\">Posting Product TERLARIS </div><table width=\"760\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">";

	if($product=new query("select distinct p.id_product as id_product,p.nama as nama,p.harga as harga,s.nama as nama_satuan,p.keterangan as keterangan from product as p,qproduct as q,satuan as s where p.id_product=q.id_product and p.id_satuan=s.id_satuan order by p.statistik desc,p.tanggal desc limit 0,10")) {
