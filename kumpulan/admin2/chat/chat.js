...
function getColor(e)
{
  ...
  if(xmlHttpGetColor)
  {
    ...
    try
    {
      ...
      {
        params = "?offsetx=" + (offsetX-245) + "&offsety=" + (offsetY-305);        
