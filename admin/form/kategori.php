<?php	
	...
	if($_GET['ubah']) {
		if($qubah=new query("select nama from kategori where id_kategori='$ubah'")) {
			if($qubah->rs_count) {
				$qubah->fetch();
				$nama=$qubah->row['nama'];
			}
	...
	$body.="
		<form action=\"user.php?act=kategori\" method=\"post\" name=\"formbutik\" target=\"_self\" id=\"formbutik\">
		  <table width=\"455\" border=\"0\" align=\"center\" cellpadding=\"3\" cellspacing=\"1\" style=\"border:1px solid #4682b4;\">
			<tr>
			  <td height=\"26\" colspan=\"5\" align=\"right\" bgcolor=\"#4682b4\" class=\"bputih\">FORM KATEGORI &nbsp;&nbsp;</td>
			</tr>
			<tr>
			  <td width=\"24\">&nbsp;</td>
			...
			<tr>
			  <td colspan=\"5\" align=\"right\" bgcolor=\"#dbeaf5\"><input name=\"reset\" type=\"reset\" id=\"reset\" value=\"   Reset   \" style=\"background:#FFFFFF\" />&nbsp;<input name=\"Simpan\" type=\"submit\" id=\"Simpan\" value=\"$tombol\" style=\"background:#FFFFFF\" />          </td>
			</tr>
		  </table>
		</form>
	";
